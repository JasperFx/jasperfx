...
public class Cache<TKey, TValue> : IEnumerable<TValue> where TKey : notnull
{
    ...
    {
        foreach (var pair in dictionary) _values = _values.AddOrUpdate(pair.Key, pair.Value);
    }
    ...
    {
        return _values.Enumerate().Select(x => x.Key);
    }
    ...
    public IDictionary<TKey, TValue> ToDictionary()
    {
        ...
        foreach (var pair in _values.Enumerate()) dict.Add(pair.Key, pair.Value);
