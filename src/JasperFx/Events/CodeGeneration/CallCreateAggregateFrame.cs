...
public class CallCreateAggregateFrame: Frame
{
    private Variable _cancellation;
    private Variable _session;
    private readonly CreateMethodCollection _methods;
    ...
    {
        _session = chain.TryFindVariable(_methods.QuerySessionType, VariableSource.All) ??
                   chain.FindVariable(_methods.FullSessionType);
