...
public class EventTypePatternMatchFrame: Frame
{
    ...
    /// <returns></returns>
    public static IEnumerable<EventProcessingFrame> SortByEventTypeHierarchy(IEnumerable<EventProcessingFrame> frames)
    {
