...
public abstract class MethodCollection
{
    ...
    public static Type[] AllEventTypes(params MethodCollection[] methods)
    {
    ...
    public static EventTypePatternMatchFrame AddEventHandling(Type aggregateType, IStorageMapping mapping,
