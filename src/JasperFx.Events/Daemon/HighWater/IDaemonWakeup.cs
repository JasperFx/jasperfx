...
/// </summary>
public interface IDaemonWakeup : IDisposable
{
    /// <summary>
...
/// </summary>
public class TaskDelayDaemonWakeup : IDaemonWakeup
{
    public virtual Task WaitAsync(TimeSpan timeout, CancellationToken token)
    {
