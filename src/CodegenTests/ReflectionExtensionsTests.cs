...
public class ReflectionExtensionsTests
{
    ...
    public void get_full_name_in_code_for_generic_type()
    {
        typeof(Handler<Message1>).FullNameInCode()
            .ShouldBe($"CodegenTests.Handler<{typeof(Message1).FullName}>");
    }
    ...
    public void full_name_of_open_generic_type_inner()
    {
        ...
        createdName.ShouldBe("CodegenTests.ReflectionExtensionsTests.Envelope<>.Inner");
    }
    ...
    public void get_full_name_in_code_for_inner_generic_type()
    {
        typeof(ISomeInterface<string>).FullNameInCode()
            .ShouldBe("CodegenTests.ReflectionExtensionsTests.ISomeInterface<string>");
    }
    ...
    [InlineData(typeof(Handler<Message1>), "Handler<CodegenTests.Message1>")]
    ...
    [InlineData(typeof(double), "double")]
    [InlineData(typeof(object), "object")]
    [InlineData(typeof(Message1), "CodegenTests.Message1")]
    [InlineData(typeof(Handler<Message1>),
        "CodegenTests.Handler<CodegenTests.Message1>")]
    [InlineData(typeof(Handler<string>), "CodegenTests.Handler<string>")]
    ...
    public void full_name_in_code_of_generic_types_nested_type()
    {
        typeof(GenericTestClassWithNested<string>.NestedTestClass).FullNameInCode().ShouldBe(
            "CodegenTests.GenericTestClassWithNested<string>.NestedTestClass");
    }
    ...
    public void to_suffixed_type_name_with_closed_name()
    {
        ...
        name1.ShouldBe("ThingBuilder1317788582");
    }
    ...
    public void to_suffixed_type_name_with_generic_type()
    {
        ...
        type.ToSuffixedTypeName("Service")
            .ShouldBe("HandlerService728762555");
    }
