...
namespace CommandLineTests.Descriptions
{
    public class DescribeCommandTests
    {
        ...
        public async Task use_lambda_description()
        {
            var builder = Host.CreateDefaultBuilder()
                .ConfigureServices(services =>
                {
                    ...
                    services.Describe<FakeService>("Fake Service #1",
                        (s, w) => w.WriteLine("Fake Service Name: " + s.Name));
                    services.Describe<FakeService>("Fake Service #2",
                        (s, w) => w.WriteLineAsync("Fake Service Name Async: " + s.Name));
                });
        ...
        public class Describer1 : ISystemPart
        {
        ...
        public class Describer2 : ISystemPart, IWriteToConsole
        {
        ...
        public class Describer3 : ISystemPart
        {
